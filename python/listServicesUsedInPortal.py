# Name: ListServicesUsedInPortal
# Create by: Justin Pan
# Created at: Jun 3, 2021 
# Description: This script is used to list all web servcioes used in the GIS portal in a date snapshot, 
# so the GIS Server team can compare the changing betwenn different months   
